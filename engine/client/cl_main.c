...
static void CL_CreateCmd( void )
{
	...
	// Use refState.vieworg which is the globally available view origin in the engine
	if( active && k_aimlock.value && CL_FindAimbotTarget( refState.vieworg, cmd->viewangles, target_angles ) )
	{
